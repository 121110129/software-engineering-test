...
public partial class Backstage_PubArticle : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (TextBox1.Text != "" && TextBox3.Text != "")
        {
                ...
                if (info_photo.HasFile) TitlePic = UPimage(570, 385);
                ...
                TextBox1.Text = "";
                TextBox3.Text = "";
                preview.ImageUrl = "../images/" + TitlePic;
    ...
    {
        string re = "";
        //TitlePic = info_photo.FileName;
        //string type = TitlePic.Substring(TitlePic.LastIndexOf(".") + 1);
        //获取网站根目录路径
        string path = HttpContext.Current.Request.MapPath("~/");
        //存储文件到磁盘
        //info_photo.SaveAs(path + "images/" + info_photo.FileName);
        //文件大小
        ...
        else
        {
            ...
            for (int i = 0; i < HFC.Count; i++)
            {
                ...
                {
                    string fullname = path + "images/" + info_photo.FileName;
                    try
                    {
                        HPF.SaveAs(fullname);
